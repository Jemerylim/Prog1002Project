...
class GrandhyattSpider(scrapy.Spider):
    name = 'grand_hyatt'
    allowed_domains = ['www.tripadvisor.com.sg']
    start_urls = ['https://www.tripadvisor.com.sg/Hotel_Review-g294265-d306175-Reviews-Grand_Hyatt_Singapore-Singapore.html#REVIEWS',]
