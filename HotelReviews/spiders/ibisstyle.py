...
class IbisstyleSpider(scrapy.Spider):
    name = 'ibis_style'
    allowed_domains = ['www.tripadvisor.com.sg']
    start_urls = ['https://www.tripadvisor.com.sg/Hotel_Review-g294265-d8623711-Reviews-Ibis_Styles_Singapore_on_Macpherson-Singapore.html',]
