...
class DiamondhotelSpider(scrapy.Spider):
    name = 'diamond_hotel'
    allowed_domains = ['www.tripadvisor.com.sg']
    start_urls = ['https://www.tripadvisor.com.sg/Hotel_Review-g294265-d5260708-Reviews-Diamond_Hotel-Singapore.html#REVIEWS',]
    ...
    def parse(self, response):
        for review in response.xpath('//div[@class="WAllg _T"]'):
            ...
            item['hotelName'] = review.xpath('./div[@class="jvqAy"]/h1[@class="QdLfr b d Pn"]')
            yield item
