...
class JenhotelSpider(scrapy.Spider):
    name = 'jen_hotel'
    allowed_domains = ['www.tripadvisor.com.sg']
    start_urls = ['https://www.tripadvisor.com.sg/Hotel_Review-g294265-d7056556-Reviews-JEN_Singapore_Orchardgateway_by_Shangri_La-Singapore.html',]
